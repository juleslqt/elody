...
module.exports = {
    name: 'evaluate',
    description: 'Evaluer une mission achevée par un membre.',
    category: 'events',
    ...
    async runInteraction(client,interaction) {
        ...
        if (!(await interaction.member.roles.cache.has(process.env.PRESIDENCE_ROLE_ID))) {
            embed = new MessageEmbed()
                    .setColor('#778899')
                    .setDescription(`Seuls les responsables ont accès à cette commande.`)
