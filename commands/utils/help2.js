...
module.exports = {
    ...
    async runInteraction(client,interaction) {
        ...
        .addFields(
            ...
            {name: 'Général', value: "> Canal général : Un canal textuel qui réunit tous les membres de l'association, il sert principalement aux grandes annonces et à communiquer avec tous les membres cependant éviter de surcharger ce canal de messages.\n> Agenda : Un canal textuel dans lequel sont publiés tous les événements ajoutés à l'agenda Google de l'Odyssée tels que les réunions.\n> Brainstorming : Un canal textuel qui vous permet de donner vos idées concernant l'association, par exemple un projet ou encore une idée de publication Instagram.", inline: false},
            {name: 'Salons de réunions', value: "> Réunion générale : C'est ici que se déroulent les réunions générales à distance\n> Canal réunion : Des canaux de réunions si celui de votre pôle est occupé ou si vous souhaitez faire une réunion inter-pôle.", inline: false},
            {name: 'Votre pôle', value: "> Groupe privé : Un canal textuel qui vous permet de communiquer avec tous les membres de votre pôle. Seul le responsable peut envoyer des messages dans ce canal, les membres doivent créer des fils pour pouvoir envoyer des messages.\n> Réunion pôle : C'est ici que se dérouleront les réunions de votre pôle à distance.", inline: false}
